...
aborted before even downloading the sources. I suspect that this is
the sole reason for all 62&nbsp;717 SRPM build failures, but my script
is still analyzing the results (the exact number of failures caused by
a missing license will be updated once it is calculated).
